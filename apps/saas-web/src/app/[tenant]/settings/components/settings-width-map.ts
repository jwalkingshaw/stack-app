...
const SETTINGS_WIDTH_MAP: Record<SettingsPageKey, SettingsWidthConfig> = {
  ...
  "output-profiles": {
    mode: "form",
    defaultClassName: "space-y-6",
    helperIntro: "Define what each channel needs so readiness is clear before publishing.",
  },
  "output-profile-detail": {
    mode: "form",
    defaultClassName: "space-y-6",
    helperIntro: "Fine-tune this channel profile so teams know what must be complete.",
  },
  markets: {
    mode: "form",
    defaultClassName: "space-y-6",
  ...
  sets: {
    mode: "form",
    defaultClassName: "space-y-6",
    helperIntro: "Create reusable sets to organize and share products or assets faster.",
  },
  "product-fields": {
    mode: "form",
    defaultClassName: "space-y-6",
  ...
  "team-partner-detail": {
    mode: "form",
    defaultClassName: "space-y-6",
    helperIntro: "Manage this partner's relationship, access, and shared set assignments.",
  },
  "team-invite": {
    mode: "form",
    defaultClassName: "space-y-6",
