        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div className="space-y-4">
            <Link
              ...
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[var(--color-accent-blue)] hover:bg-[var(--color-accent-blue-hover)]"
            >
            ...
            <Link
              href="/"
              className="w-full flex justify-center py-2 px-4 text-sm font-medium text-[var(--color-accent-blue)] hover:text-[var(--color-accent-blue-hover)]"
            >
              ← Back to Home
            </Link>
          </div>
