...
>(({ className, size = "sm", ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:border-[var(--color-accent-black)] data-[state=checked]:bg-[var(--color-accent-black)] hover:data-[state=checked]:border-[var(--color-accent-black-hover)] hover:data-[state=checked]:bg-[var(--color-accent-black-hover)] data-[state=checked]:active:bg-[var(--color-accent-black-active)] focus-visible:ring-[var(--color-accent-black)]",
      className
    )}
    {...props}
    ref={ref}
